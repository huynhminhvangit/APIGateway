...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.vdev.microservice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.vdev.microservice.security.DomainUserDetailsService", "createSpringSecurityUser");
